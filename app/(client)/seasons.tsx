...
const SPECIES_INFO: Record<string, SpeciesInfo> = {
  ...
  'Marlín azul':         { name: 'Marlín azul',          wikimedia: 'Atlantic blue marlin',     weight: '80-200 kg',technique: 'Tróleo de altura',          emoji: '🐟' },
  'Marlín rayado':       { name: 'Marlín rayado',        wikimedia: 'Striped marlin Pacific',   weight: '30-90 kg', technique: 'Tróleo / curricán',         emoji: '🐟' },
  'Marlín':              { name: 'Marlín',               wikimedia: 'Atlantic blue marlin',     weight: '50-150 kg',technique: 'Tróleo de altura',          emoji: '🐟' },
  ...
  'Sierra':              { name: 'Sierra',               wikimedia: 'Pacific king mackerel',    weight: '2-8 kg',   technique: 'Curricán / cuchara',        emoji: '🐟' },
  'Jurel':               { name: 'Jurel',                wikimedia: 'Amberjack fish',           weight: '3-15 kg',  technique: 'Jigging / carnada',         emoji: '🐟' },
  'Robalo':              { name: 'Robalo',               wikimedia: 'Common snook',             weight: '2-10 kg',  technique: 'Carnada viva / señuelo',    emoji: '🐟' },
  'Huachinango':         { name: 'Huachinango',          wikimedia: 'Red snapper',              weight: '1-5 kg',   technique: 'Fondo / carnada',           emoji: '🐡' },
  'Mojarra':             { name: 'Mojarra',              wikimedia: 'Eucinostomus fish',        weight: '0.5-2 kg', technique: 'Orilla / carnada',          emoji: '🐠' },
  'Pargo':               { name: 'Pargo',                wikimedia: 'Lane snapper',             weight: '1-5 kg',   technique: 'Fondo / curricán',          emoji: '🐡' },
